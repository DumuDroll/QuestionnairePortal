...
public class Constants {
    ...
    public static final String USER_ACTIVATION_LINK = "Activate account on a link: http://localhost:8080/registrationActivation?key=";
    ...
    public static final String PASSWORD_CHANGE_LINK = "Confirm password change on a link: http://localhost:8080/passChangeActivation?key=";
}
