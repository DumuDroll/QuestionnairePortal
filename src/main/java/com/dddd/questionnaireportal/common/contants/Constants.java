...
public class Constants {
    ...
    public static final String USER_ACTIVATION_LINK = "Activate account on a link: http://localhost:8080/registrationActivation.xhtml?key=";
    ...
    public static final String PASSWORD_CHANGE_SUBJECT = "Confirm password change on Questionnaire Portal";
    public static final String PASSWORD_CHANGE_LINK = "Confirm password change on a link: http://localhost:8080/passChangeActivation.xhtml?key=";
}
